                  ...
                  <div className="row g-4 g-md-5">
                    <Col md={6}>
                      <Select
                        ...
                        data={[
                          { value: "Проблема с платежной системой или выводом средств", title: "Проблема с платежной системой или выводом средств" },
                          { value: "Покупатель не подтверждает сделку", title: "Покупатель не подтверждает сделку" },
                          { value: "Возврат средств при отсутствии продавца", title: "Возврат средств при отсутствии продавца" },
                          { value: "Обращение для снятия ограничений на вывод средств", title: "Обращение для снятия ограничений на вывод средств" },
                          { value: "Восстановление доступа к учетной записи", title: "Восстановление доступа к учетной записи" },
                          { value: "Спорные ситуации / арбитраж", title: "Спорные ситуации / арбитраж" },
                          { value: "Жалоба на пользователя", title: "Жалоба на пользователя" },
                          { value: "Персональные данные", title: "Персональные данные" },
                          { value: "Иные вопросы", title: "Иные вопросы" },
                        ]}
                      />
                    </Col>
                    <Col md={6}>
