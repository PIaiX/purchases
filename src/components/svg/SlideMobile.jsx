...
const SlideMobile = ({ className, img, declension }) => {
  return (
    <svg className={className} width="335" height="266" viewBox="0 0 335 266" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
      <image id="imgMobile" x="-55" y="35" width="445" height="250" xlinkHref={img} clipPath="url(#figure-3)" />
      <rect x="25" width="70" height="70" rx="35" fill="currentColor" />
      <foreignObject x="25" y="0" width="70" height="71">
        <div className="lots">
