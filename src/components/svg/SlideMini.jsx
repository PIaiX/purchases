...
const SlideMini = ({ className, img, declension }) => {
  return (
    <svg className={className} width="260" height="318" viewBox="0 0 260 318" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <image id="imageMini" preserveAspectRatio="xMidYMid slice" width="230" height="430" xlinkHref={img} clipPath="url(#figure-2)" />
      <rect x="200" y="221" width="60" height="60" rx="30" fill="currentColor" />
      <foreignObject x="200" y="221" width="60" height="60">
        <div className="lots">
