...
const SlideFull = (props) => {
  return (
    <svg className={props.className} preserveAspectRatio="none" width="899" height="524" viewBox="0 0 899 524" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
