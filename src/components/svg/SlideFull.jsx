...
const SlideFull = (props) => {
  return (
    <svg className={props.className} width="899" height="413" viewBox="0 0 899 413" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <image id="imageFull" preserveAspectRatio="xMidYMid slice" width="899" height="413" xlinkHref={props.img} clipPath="url(#figure-1)"/>
