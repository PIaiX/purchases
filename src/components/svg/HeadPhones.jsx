...
const HeadPhones = (props) => {
  return (
    <svg width="24" height="24" stroke="currentColor" class={props.className} strokeWidth={2} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M10 16C10 16 10.8 17 12 17C13.3 17 14 16 14 16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  );
};
